...
public function cougulationtest(){
    return view('cougulationtest');
}
public function cougulationpanels(){
    return view('cougulationpanels');
}
public function cougulationdefination(){
    return view('cougulationdefination');
}
