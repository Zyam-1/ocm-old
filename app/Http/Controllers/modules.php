...
class modules extends Controller
{
     ...
     public function add(Request $request)
    {
        ...
        DB::insert('insert into modules (ID,pagename, name, System, permissions, created_at, created_by) values (?, ?, ?, ?, ?, ?, ?)', 
            [$id, $pagename,$name, $system, $permissions, date('Y-m-d H:i:s'), $user['id'] ] );  
      ...
      public function update(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            update modules 
            set 
            pagename='$pagename',name = '$name', permissions = '".$permissions."', System = '".$system."', updated_at = '".date('Y-m-d H:i:s')."',  
