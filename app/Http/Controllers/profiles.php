            ...
            $data = DB::table('testprofiles') 
                         ->select(
                            ...
                            'testprofiles.level',
                             ...
                             DB::raw('CONCAT(testprofiles.dpp," ",testprofiles.dppType) AS dppType'),
                            'testprofiles.name',
                     ...
                     ->when(!empty($ids) , function ($query) use($request,$ids){
                        
                         return $query->orderByRaw("FIELD(testprofiles.id , $ids) desc");
     ...
     public function add(Request $request)
    {
       ...
       $code= $request->code;
        ...
        $validator = Validator::make($request->all(), [
            'level' => 'required',
            'code' => 'required|unique:testprofiles,code', 
        ...
        DB::insert('insert into testprofiles (id, level, btcheck, mandatory, name, specialhandling, diagnostics, department, dppType, dpp, dppHours, InUse, rcf, created_at, created_by,code) values (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', 
            [$id, $level, $btcheck, $mandatory, $name, $specialhandling, $diagnostics, $department, $dppType, $dpp, $dppHours, $InUse, $rcf, date('Y-m-d H:i:s'), $user['id'] ,$code] );  
      ...
      public function update(Request $request)
    {
       $code= $request->code;
        ...
        $validator = Validator::make($request->all(), [
            'id' => 'required',
            'level' => 'required',
            'code' => 'required|unique:testprofiles,code,'.$id,  
