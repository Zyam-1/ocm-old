  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-0">
          <div class="col-sm-6">
            <h1 class="m-0">Sample Containers </h1>
          </div><!-- /.col -->
          <div class="col-sm-6  d-none d-sm-none d-md-block ">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('/')}}">Home</a></li>
              <li class="breadcrumb-item active">Sample Containers </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">                  
                                <h5>Container Info</h5>   
                                  ...
                                  <form id="form">
                                            ...
                                            <label  class="col-form-label">Container Type <span>*</span></label>
                                                 <select class="form-control" name="type" id="type">
                                                        @foreach ($data['SCTs'] as $SCT)
                                                        <option value="{{$SCT->id}}" 
                                                            @if($SCT->Default == 'Yes')
                                                            selected=""
                                                            @endif
                                             ...
                                             <div class="col-md-6">
                                            <label  class="col-form-label">Min Volume <span>*</span></label>
                                                 <input type="text" class="form-control" id="min_vol" name="min_vol" value="" />
                                             </div>

                                             <div class="col-md-6">
                                            <label  class="col-form-label">Max Volume <span>*</span></label>
                                                 <input type="text" class="form-control" id="max_vol" name="max_vol" value="" />
                                             </div> 
                                            ...
                                            <div class="row px-2">
                                             ...
                                             <div class="custom-control custom-radio">
                                              ...
                                              <label for="status1" class="custom-control-label">Yes</label>
                                            </div>
                                            &nbsp;&nbsp;&nbsp;
                                            <div class="custom-control custom-radio">
                                              <input class="custom-control-input" type="radio" id="status2" name="status" value="0">
                                              <label for="status2" class="custom-control-label">No</label>
                                            </div>
...
<script type="text/javascript">
 ...
 var table = $('#table').DataTable({
        ...
        // stateSave: true,
        ajax: {
            url: "{{ route('SampleContainers') }}",
            method: 'POST'
        },
         columns: [
            {data: 'name', name: 'name'},
            {data: 'type', name: 'C.Text'},
            {data: 'min_vol', name: 'min_vol'},
            {data: 'max_vol', name: 'max_vol'},
...
table.on('click', '.update', function() {
        ...
        var id = table.row($tr).data().id;
              ...
              function(data){
                ...
                if(data.length > 0) {
                    ...
                    $('#min_vol').val(data[0].min_vol);
                    $('#max_vol').val(data[0].max_vol);
  ...
  table.on('click', '.delete', function() {
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.post("{{ route('deleteSampleContainer') }}",
            {
                id: data.id 
            });
              $(tr_id).fadeOut(1000);
           ...
           $(".clear").click(function (event) {
            ...
            $(".AddUpdatebtn").click(function (event) {
                    ...
                    if($('#id').val() > 0) {
                        ...
                        var url = "{{ route('updateSampleContainer') }}";        
                        ...
                        var url = "{{ route('addSampleContainer') }}";   
