                 ...
                 <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-5">
                        ...
                        <input type="date" name="between" class="form-control">
                    </div>
                    <div class="col-md-5">
                        <label class="form-label">And</label>
                        <input type="date" name="and" class="form-control">
                    </div>
...
var table=$('#table').DataTable({
 ...
 columns: [
   ...
   {data: 'reasonunlock ', name: 'reasonunlock'},
