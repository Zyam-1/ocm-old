  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-0">
          <div class="col-sm-6">
            <h1 class="m-0">Totals For Biochemistry </h1>
          </div><!-- /.col -->
      ...
      <div class="container-fluid">
                            ...
                            <form id="form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <label class="form-check-label" for="Clinicians">Clinicians</label>
                                                    </div>
                                                    <div class="form-check form-check-inline mt-1">
                                                    <input class="form-check-input" type="radio" name="Source" id="Wards" value="Ward">
                                                    <label class="form-check-label" for="Wards">Wards</label>
                                                    </div>
                                                    <div class="form-check form-check-inline mt-1">
                 ...
                 <div class="col-md-12">
                         ...
                         <div class="card card-primary card-outline">
                            ...
                            <div class="col-md-3 text-center bg-primary" style="border:2px solid white;">
                                <h4>Biochemistry</h4>
                            </div>
                            <div class="col-md-3 text-center bg-primary" style="border:2px solid white;">
                                <h4>Immunology</h4>
                            </div>
                            <div class="col-md-4 text-center bg-primary" style="border:2px solid white;">
                                <h4>Endocrinology</h4>
                            </div>
