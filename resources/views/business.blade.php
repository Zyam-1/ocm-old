            ...
            <div class="card card-primary card-outline card-tabs">
              ...
              <div class="card-body">
               ...
               <div class="tab-pane fade" id="custom-tabs-three-messages" role="tabpanel" aria-labelledby="custom-tabs-three-messages-tab">
                ...
                <button type="button" id="cleanDatabase" class="update btn btn-primary float-left">Clean Database</button>
               ...
               <div class="tab-pane fade fontTab" id="custom-tab-font_" role="tabpanel" aria-labelledby="font_">
                    ...
                    <link href="/ocm/public/fonts/Nunito/Nunito-Regular.woff" rel="stylesheet">
                    ...
                    <link href="/ocm/public/fonts/PT-Sans/PTSans-Regular.woff" rel="stylesheet">
                    ...
                    <div class="jumbotron mb-1 col-md-6" id="Raleway">
                      <link href="/ocm/public/fonts/Raleway/Raleway-Regular.woff" rel="stylesheet">
                    ...
                    <div class="jumbotron mb-1 col-md-6" id="Finlandica">
                      <link href="/ocm/public/fonts/Finlandica/Finlandica-Regular.woff" rel="stylesheet">
                    ...
                    <div class="jumbotron mb-1 col-md-6" id="Kantumruy_Pro">
                      <link href="/ocm/public/fonts/Kantumruy-Pro/KantumruyPro-Regular.woff" rel="stylesheet">
                    ...
                    <div class="jumbotron mb-1 col-md-6" id="Montserrat">
                      <link href="/ocm/public/fonts/Montserrat/Montserrat-Regular.woff" rel="stylesheet">
                    ...
                    <div class="jumbotron mb-1 col-md-6" id="Titillium_Web">
                      <link href="/ocm/public/fonts/Titillium-Web/TitilliumWeb-Regular.woff" rel="stylesheet">
...
<script src="{{asset('knockout.min.js')}}"></script>
