                                ...
                                <h5>Add New {{$data['name']}}</h5>   
                                  ...
                                  <form id="form">
                                            ...
                                            <label  class="col-form-label">Name <span>*</span></label>
                                                 ...
                                                 <input type="hidden" class="form-control" id="type" name="type" value="{{$data['code']}}" />
        ...
        var id = table.row($tr).data().id;
              ...
              function(data){
                ...
                if(data.length > 0) {
                    ...
                    $('#type').val(data[0].ListType).trigger('change');
