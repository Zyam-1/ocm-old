  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-0">
          <div class="col-sm-6">
            <h1 class="m-0">Sub Departments </h1>
          </div><!-- /.col -->
      ...
      <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">                  
                                <h5 class="heading">New Sub Deparment</h5>   
                                  ...
                                  <form id="form">
                                            ...
                                            <label  class="col-form-label">Description</label>
                                              ...
                                              <div class="col-md-12">
                                            <label class="col-form-label">Parent Department <span>*</span></label>
                                                  <select class="form-control" name="department" id="department">
                                                    <option value="">Choose a Department</option>
                                                        @foreach ($data['userdepartments'] as $userdepartment)
 ...
 var table = $('#table').DataTable({
        ...
        "order":[[1, 'asc']],
         ...
         dom: "Blfrtip",
                ...
                { "visible": false, "targets": [0,2,5,6,7,8] }
                ], 
...
table.on('click', '.update', function() {
  ...
  table.on('click', '.delete', function() {
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.post("{{ route('deleteSubDepartment') }}",
            {
                id: data.id 
            });
              $(tr_id).fadeOut(1000);
           ...
           $(".clear").click(function (event) {
            ...
            $(".AddUpdatebtn").click(function (event) {
                    ...
                    if($('#id').val() > 0) {
                        ...
                        var url = "{{ route('updateSubDepartment') }}";        
                       
                    } else {

                        var url = "{{ route('addSubDepartment') }}";   
