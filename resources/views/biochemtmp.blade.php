  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-0">
          <div class="col-sm-6">
            <h1 class="m-0">Biochemistry Comments
...
<?php if(count($biotemp) > 0){ ?>

  @foreach($biotemp as $bio)

<option value="{{$bio['CommentID']}}" id="coagcom">{{$bio['CommentName']}}</option>
