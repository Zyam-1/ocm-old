                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="card-body">                  
                                  ...
                                  <form id="form">
                                    ...
                                    <div class="row">
                                            <div class="col-md-3">
                                                    <label for="form-label" id="from">From</label>
                                                    <input type="date" class="form-control" id='date2' for="from" name="fromdate">
                                                </div>

                                                <div class="col-md-3">
                                                    <label for="form-label" id="to">To</label>
                                                    <input type="date" class="form-control" id='date1' for="to" name="todate">
                                                </div>
                                        ...
                                        <button type="button" class="btn btn-primary calculate">Calculate</button>
                                           ...
                                           <div class="col-md-12 mt-2">
                                            ...
                                            <div class="form-check form-check-inline mt-1">
                                            <input class="form-check-input" type="radio" name="radio" id="A" value="option1">
                                            <label class="form-check-label" for="A">A</label>
                                            </div>
                                            <div class="form-check form-check-inline mt-1">
                                            <input class="form-check-input" type="radio" name="radio" id="%" value="option2">
