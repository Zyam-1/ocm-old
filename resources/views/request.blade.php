...
<style type="text/css">
  ...
  <div class="content-wrapper">
                                 ...
                                 <form id="form">
                                     ...
                                     <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-2">
                                          ...
                                          <input type="hidden" name="bttype" id="bttype">
                                          ...
                                          if(request()->segment(1) == 'requestPatient' || request()->segment(1) == 'requestEpisode' || request()->segment(1) == 'Requests' || request()->segment(1) == 'Request') {

                                            $requestType = 'Request';

                                          
                                          } elseif(request()->segment(1) == 'requestPatientBT') {

                                                $requestType = 'BTRequest';
                                          }
                                          ...
                                          <input type="hidden" name="rtype" id="rtype" value="{{$requestType}}">
                                        ...
                                        <div class="card card-primary card-outline d-none patientInfo">
                                          <div class="card-body box-profile p-0 px-2 pt-1">
                                            ...
                                            <ul class="list-group list-group-unbordered mb-3">
                                              ...
                                              <li class="list-group-item p-1 bg d-none">
                                                <b>Blood Group</b> <a class="float-right" id="bg"></a>
                                              </li>
                                              <li class="list-group-item p-1">
                                      ...
                                      <div class="col-md-4 mb-2">      
                                         ...
                                         <div class="card card-primary card-outline d-none clinicianInfo">
                                          <div class="card-body box-profile p-0">
                                           <textarea rows="3" class="form-control" placeholder="Clinician Details *" id="clinicalDetail" name="clinicalDetail"></textarea>
                                         </div>
                                       </div>
                                    ...
                                    <div class="col-md-4">   
                                      ...
                                      <div class="input-group mb-2 clinicDiv">
                                        ...
                                        <div class="input-group mb-2">
                                          <div class="input-group-prepend">
                                            <span class="input-group-text bg-primary border border-primary"><i class="fas fa-bed"></i></span>
                                          </div>
   ...
   <button type="button" id="addMultiple" class="btn btn-primary float-left mb-1 mr-1"><i class="fas fa-plus"></i> Add Profiles by Panels</button>
       <button type="button" id="addProduct" class="btn btn-warning float-left mb-1"><i class="fas fa-plus"></i> Test / Profile</button>
        ...
        <button type="button" id="showSamples" class="availableSamplesBtn d-none btn btn-danger float-left mb-1 ml-1"><i class="fas fa-vials"></i> &nbsp; Available Samples</button>
                                    ...
                                    <div class="col-md-12"></div>
                                     ...
                                     <div class="testList col-md-12">
                                        ...
                                        <div class="row mt-0 px-0 pb-1 rounded testInfo" id="2">
                                        ...
                                        <div class="col-md-4 bg-light  p-1">
                                            ...
                                            @foreach ($data['quicktestprofiles'] as $quicktestprofile)
                                              <option data="{{$quicktestprofile->rcf}}" data2="{{$quicktestprofile->dppHours}}" data3="{{$quicktestprofile->diagnostics}}" value="{{$quicktestprofile->id}}">{{$quicktestprofile->name}}</i></option>
                                              @endforeach
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea name="description[]" id="description" rows="1" class="form-control description" placeholder="Profile Description"></textarea>


                                             <input type="hidden" name="reason[]" id="reason"  class="form-control reason"/>
                                      ...
                                      <div id="scrollPoint"></div>
                                            ...
                                            <div class="col-md-5 mt-5">
                                              ...
                                              <div id="questionsLength" class="d-none">
                                          ...
                                          <select class="form-control"  id="clinicians">
                                            ...
                                            @foreach ($data['Clinicians'] as $Clinician)
                                              <option value="{{$Clinician->id}}">
                                                {{$Clinician->Text}}
                                                @if($Clinician->Title != '')
                                                 - {{$Clinician->Title}} {{$Clinician->ForeName}} {{$Clinician->SurName}}  
                                                @endif
                                              </option>
                                              @endforeach
                                          </select>
                ...
                <div class="modal fade" id="addMultipleModal" tabindex="-1" aria-hidden="true">
                  ...
                  <!-- Modal -->
                <div class="modal fade bloodGroupInfo" id="bloodGroupInfo" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg  modal-dialog">
                        <div class="modal-content">
                           <div class="modal-header bg-primary">
                                <h5 class="modal-title text-white">Getting Blood Group Info</h5>
                               <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                            <div class="row">
                            <div class="col-lg-12 text-center" id="bloodResults">
...
console.log(OCMRequest[0].RequestClinicalDetail);  

            // $('#clinicalDetail').html(OCMRequest[0].RequestClinicalDetail);
      ...
      function loadpatients() {
             ...
             $( "#antibiotics" ).select2({
                placeholder:'Choose Currently Used Antibiotics',
                allowClear:true,
                tags:true
               });

              $( "#intendedantibiotics" ).select2({
                placeholder:'Choose Intended Antibiotics',
                allowClear:true,
                tags:true
               });
              ...
              $( "#clinic" ).select2({
               ...
               $('.tests').select2({
                    ...
                    searchInputPlaceholder: 'Search by Name or Diagnostics',
      ...
      function loadQuestions(session) {
                 ...
                 var existingProfileIDs = profileIDs();
                   ...
                   $.get("{{route('GetProfileQuestions')}}", 
                    ...
                    $('#questionsLength').attr('style', 'display: block !important'); 

                } else {

                    $('#questionsList').html('<div class="col-md-12"></div>');
                    
                    $('#questionsLength').attr('style', 'display: none !important'); 
                }
             ...
             $.get("{{route('GetProfileThreshHold')}}", 
              ...
              if(data.error != '') {
                   ...
                   Swal.fire({
                            ...
                            inputValidator: (value) => {
                             ...
                             if (value != '') {
                                 ...
                                 if(mode == 'add-on') {
                                  ...
                                  resolve('Please enter the reason.')
                                } 
                    ...
                    $('.swal2-textarea').attr('placeholder','Enter the reason.')
            ...
            if(mode == 'on') { 
              ...
              localStorage.setItem('request', OCMRequestQuestionsDetails[0].session);
                 ...
                 if(OCMRequestQuestionsDetails.length > 0) {
                    ...
                    $('#questionsList').html('');
                     ...
                     $( data ).each(function( index ) { 
                        ...
                        questionsList =  '<div style="font-size:16px;" class="text-capitalize col-md-5"><label>'+data[index].question+'</label></div><div class="col-sm-7 text-right text-capitalize"> <div class="form-group clearfix answersList-'+index+'"></div></div><div class="text-capitalize col-md-12"><hr class="mt-1"/></div>';
               ...
               var patient = new Option(name, id, true, true);
                ...
                if(OCMRequest[0].Antibiotics != null) {

                 const antibiotics = OCMRequest[0].Antibiotics.split(",");
                      antibiotics2 = splitCsv(OCMRequest[0].Antibiotics);
                      $('#antibiotics').val(antibiotics2).trigger('change'); 
                       
                }
                
                if(OCMRequest[0].IntendedAntibiotics != null) {  

                const intendedantibiotics = OCMRequest[0].IntendedAntibiotics.split(",");
                      intendedantibiotics2 = splitCsv(OCMRequest[0].IntendedAntibiotics);
                      $('#intendedantibiotics').val(intendedantibiotics2).trigger('change'); 
                ...
                if(OCMRequest[0].RequestWardID == null || OCMRequest[0].RequestWardID == '') {
                 ...
                 $.ajax({
                    ...
                    $('#patage').text(age);
                    $('#patmrn').text(OCMRequest[0].Chart);
                   
                    var DoB = OCMRequest[0].DoB;
                    DateFormat(DoB)
    ...
    if ($.trim(params.term) === '') {
                ...
                return null;          
                  ...
                  if(mode == 'add-on') { 
                    ...
                    $('.availableSamplesBtn').attr('style', 'display: inline-block !important');
               ...
               var patient = new Option(name, id, true, true);
                ...
                if(Patient[0].Ward == null || Patient[0].Ward == '') {
                 ...
                 $.ajax({
                    ...
                    $('#patage').text(age);
                    $('#patmrn').text(Patient[0].Chart);
                    var DoB = Patient[0].DoB;
                    DateFormat(DoB)
                ...
                if(Patient[0].Ward == null || Patient[0].Ward == '') {
                 ...
                 $.ajax({
                    ...
                    $('#patvisits').text(Patient[0].Visits);
                       ...
                       $('#bloodGroupInfo').modal('show'); 


                               $('#bloodResults').html('<i class="fas fa-spinner fa-pulse"></i>');    
                                  
                               $.ajax({
                                  type: 'post',
                                  url:"{{ route( 'checkBloodGroupInfo') }}",  
                                  data: {'Chart' : Patient[0].Chart, _token: CSRF_TOKEN},
                                  dataType: 'json',                   
                                  success: function(response__){ 
                                      ...
                                      if(response__[0] == 'yes') {
                                           ...
                                           //$('#bloodResults').html('<h1>Blood Group is '+response__.fgroup+'</h1>');  
                                           $('#bg').text(response__[1]); 
                                           $('.bg').attr('style', 'display: block !important');
                                           
                                           $('#bloodGroupInfo').modal('hide'); 
                                           // $(".tests option[value='83']").detach();
                                           ...
                                           $('#bloodResults').html('<h1>Patient details not found.</h1>'); 
                                           $('#bloodGroupInfo').modal('hide'); 
                                          // $('.tests').select2('open');
                                          // $('.tests').val(104).trigger('change');
                                         //  $('.tests').val(83).trigger('change');
                                          
                                           $('#bg').text('-'); 
                                           $('.bg').attr('style', 'display: block !important');
                                          // $('#addProduct').trigger('click'); 
                                           // $('#3.testInfo').find('.tests').val(82).trigger('change'); 
                                          //  $('#3.testInfo').find('.tests').val(103).trigger('change'); 
                                             //$(".tests option[value='104']").detach();
                                            $('#bttype').val('bgnotfound');
    ...
    function load_data(mrn = '', clinicians = '', wards = '')
     {
        ...
        "order":[[1, 'asc']]
                 ...
                 $(document).on('click', '.addPatient', function (e) { 
                    ...
                    $('#bed').val(bed);
                    var a=$('#clinicalDetail').val(clinicianDetails);
                    // alert(a);
                ...
                $.ajax({
                        ...
                        success: function(accounts){ 
                            ...
                            if('{{$requestType}}' == 'BTRequest' || '{{$requestType}}' == 'requestPatientBT') {
                               ...
                               $.ajax({
                                  type: 'post',
                                  url:"{{ route( 'checkBloodGroupInfo') }}",  
                                  data: {'Chart' : Chart, _token: CSRF_TOKEN},
                                  dataType: 'json',                   
                                  success: function(response__){ 
            ...
            if(mode == 'on') {
              ...
              <?php if(request()->segment(1) == 'Request') {
          ...
          $(document).on('select2:open', '#clinicians', function () { 

                    $(".select2-search__field")[0].focus();
               })

          $(document).on('select2:open', '#ward', function () { 

                    $(".select2-search__field")[0].focus();
               })

          $(document).on('select2:open', '#clinic', function () { 

                    $(".select2-search__field")[0].focus();
               })


          $(document).on('select2:open', '#clinician', function () { 
