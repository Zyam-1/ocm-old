  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-2 mx-3">
        ...
        <label class="form-check-label">XLD/DCA</label>
       
      </div>
      <div class="col-md-2 mx-3">
         <input type="radio" name="listType" class="form-check-input ">
        <label class="form-check-label">SMAC</label>
       
      </div>
     <div class="col-md-2 mx-3">
         <input type="radio" name="listType" class="form-check-input ">
        <label class="form-check-label">Preston/CCDA</label>
